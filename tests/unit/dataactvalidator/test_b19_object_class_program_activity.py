...
def test_column_headers(database):
    ...
    actual = set(query_columns(_FILE, database[0].stagingDb))
...
def test_success(database):
    ...
    assert number_of_errors(_FILE, database[0].stagingDb, models=[op1, op2, op3, op4, op5, op6,
...
def test_optionals(database):
    ...
    assert number_of_errors(_FILE, database[0].stagingDb, models=[op1, op2]) == 1
